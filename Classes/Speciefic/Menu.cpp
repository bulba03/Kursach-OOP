...
void Menu::ShowWorkers(std::vector<Worker> workers) {
    cout<<right<<setw(20)<<"Номер|"<<setw(20)<<"Имя|"<< setw(20)<<"Возраст|"<<setw(20)<<"Зарплата|"<<setw(20)<<"Специальность"<<setw(20)<<endl;
...
void Menu::ShowLabor(vector<AvaliableWorker> avaliableWorkers) {
    cout<<right<<"Номер|"<<setw(20)<<"Имя|"<< setw(20)<<"Возраст|"<<setw(20)<<"Зарплата|"<<setw(20)<<"Специальность"<<setw(20)<<"Стаж работы"<<setw(20)<<endl;
